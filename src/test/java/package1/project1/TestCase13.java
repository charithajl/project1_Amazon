...
public class TestCase13 extends TestCaseLoginTOAmazon{
...
//	private static final String netbanking = null;
	...
	public void couponcode()
	{
		...
		Assert.assertEquals(checkoutpage.couponCodeAssertion(), "The promotional code you entered is not valid."); 
